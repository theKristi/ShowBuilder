...
import { generateProPresenterBuffer } from "@/lib/propresenter-pro";
...
export async function POST(req: NextRequest) {
  try {
    ...
    const fileBuffer = generateProPresenterBuffer(normalizedSlides, {
      title: safeTitle,
    ...
    return new NextResponse(new Uint8Array(fileBuffer), {
      ...
      headers: {
        ...
        "Content-Disposition": `attachment; filename="${safeFileName || "presentation"}.pro"`,
      },
    });
  } catch (err) {
